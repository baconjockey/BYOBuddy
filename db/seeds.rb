# rake db:reset
# rake data:load_pairing_descriptors
# rake data:load_beer_styles
# rake data:load_pairings


Category.destroy_all
["Main Ingredient", "Cuisine"].each { |category| Category.create :name => category }

# # Create Main Ingredients (to be renamed pairing_descriptors) 
# PairingDescriptor.destroy_all
# ["Seafood", "Beef", "Pork", "Lamb", "Chicken", "Game", "Dessert"].each { |ingredient| PairingDescriptor.create :name => ingredient, :category => Category.find_by_name('Main Ingredient') }
# 
# # Create Cuisines
...
# Pairing.create :beer_style => BeerStyle.find_by_name('Lambic'), :pairing_descriptor => PairingDescriptor.find_by_name('Lamb')
# Pairing.create :beer_style => BeerStyle.find_by_name('Lambic'), :pairing_descriptor => PairingDescriptor.find_by_name('Chicken')
...
# Pairing.create :beer_style => BeerStyle.find_by_name('Belgian Pale Ale'), :pairing_descriptor => PairingDescriptor.find_by_name('Beef')
# Pairing.create :beer_style => BeerStyle.find_by_name('Belgian Pale Ale'), :pairing_descriptor => PairingDescriptor.find_by_name('Seafood')
...
# Pairing.create :beer_style => BeerStyle.find_by_name('Saison'), :pairing_descriptor => PairingDescriptor.find_by_name('American (Traditional)')
